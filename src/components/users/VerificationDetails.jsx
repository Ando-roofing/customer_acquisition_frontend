...
export default function VerificationDetails() {
    ...
    const fetchVerification = async () => {
      try {
        const res = await axios.get(
          `http://127.0.0.1:8000/verifications/visits/my-submissions/${id}/`,
  ...
  return (
    <div className="container py-3" style={{ maxWidth: "95%" }}>
      <div className="border rounded-4 shadow-sm p-4" style={{ background: "transparent", border: "1px solid #ddd" }}>
        ...
        <div className="row g-4">
          <div className="col-md-6">
            ...
            {renderField("Message", verification.message)}
          </div>

          <div className="col-md-6">
            {renderField("Sent To", verification.sent_to_name)}
