...
export default function UserVerificationMessages() {
  ...
  const fetchMessages = async () => {
    ...
    try {
      const res = await axios.get(
        `http://127.0.0.1:8000/verifications/user-verifications/${verificationId}/messages/`,
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await axios.post(
        `http://127.0.0.1:8000/verifications/user-verifications/${verificationId}/messages/send/`,
        { message: newMessage },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <small>Chat with your supervisor</small>
      </div>
